# Generated by Django 2.2 on 2020-04-25 21:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to='blog_images', verbose_name='博客图片')),
                ...
                ('category', models.ManyToManyField(to='blog.CategoryModel', verbose_name='博客分类')),
                ('templatetags', models.ManyToManyField(to='blog.TagModel', verbose_name='博客标签')),
            ],
            options={
                'verbose_name': '博客',
